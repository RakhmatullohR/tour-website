...
// .wrangler/tmp/pages-b7IUeC/functionsWorker-0.8555749953428791.mjs
...
var clean = /* @__PURE__ */ __name2((value, max = 500) => value === null || value === void 0 ? "" : String(value).replace(/[\u0000-\u001f\u007f]/g, " ").trim().slice(0, max), "clean");
var normalisePhone = /* @__PURE__ */ __name2((raw) => {
...
async function parseBody(request) {
  ...
  if (type.includes("application/json") || type.includes("text/plain")) {
    try {
      ...
      if (raw && typeof raw === "object") return { data: raw, native: false };
    } catch {
    }
...
function buildText(data, phone) {
  const f = /* @__PURE__ */ __name2((key, max) => clean(data[key], max), "f");
  const line = /* @__PURE__ */ __name2((label, value) => value ? `${label}: ${value}
` : "", "line");
  return `Yangi ariza (${f("form", 20)})
` + line("Ism", f("name", 120)) + `Tel: ${phone}
` + line("Email", f("email", 160)) + line("Yonalish", f("destination", 160)) + line("Tur", f("tourTitle", 200)) + line("Sana", f("dates", 40)) + line("Kishi", f("pax", 20)) + line("Aloqa", f("contactPref", 20)) + line("Izoh", clean(data.message || data.comment, 2e3)) + `Til: ${f("locale", 8)}  -  ${f("page", 300)}`;
}
__name(buildText, "buildText");
__name2(buildText, "buildText");
var TELEGRAM_TIMEOUT_MS = 3500;
async function sendTelegram(env2, text) {
  const url = `https://api.telegram.org/bot${env2.TG_TOKEN}/sendMessage`;
  let last = "unknown";
  for (let attempt = 1; attempt <= 2; attempt++) {
    try {
      const res = await fetch(url, {
        ...
        body: JSON.stringify({ chat_id: env2.TG_CHAT_ID, text, disable_web_page_preview: true }),
...
__name2(sendTelegram, "sendTelegram");
var json = /* @__PURE__ */ __name2((body, status) => new Response(JSON.stringify(body), {
  status,
  headers: { "Content-Type": "application/json; charset=utf-8" }
}), "json");
function nativeFailure(locale) {
  const ru = locale === "ru";
  const title2 = ru ? "\u0417\u0430\u044F\u0432\u043A\u0430 \u043D\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430" : "Ariza yuborilmadi";
  const text = ru ? "\u041F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u0442\u0435\u0445\u043D\u0438\u0447\u0435\u0441\u043A\u0430\u044F \u043E\u0448\u0438\u0431\u043A\u0430. \u041F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430, \u0441\u0432\u044F\u0436\u0438\u0442\u0435\u0441\u044C \u0441 \u043D\u0430\u043C\u0438 \u043D\u0430\u043F\u0440\u044F\u043C\u0443\u044E \u2014 \u0432\u0441\u0435 \u043A\u0430\u043D\u0430\u043B\u044B \u043D\u0430 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0435 \u043A\u043E\u043D\u0442\u0430\u043A\u0442\u043E\u0432." : "Texnik xatolik yuz berdi. Iltimos, biz bilan bevosita bog\u02BBlaning \u2014 barcha kanallar kontaktlar sahifasida.";
  const back = ru ? "\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u043A\u043E\u043D\u0442\u0430\u043A\u0442\u044B" : "Kontaktlarni ochish";
  return new Response(
    `<!doctype html><html lang="${ru ? "ru" : "uz"}"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${title2}</title><body style="font:16px/1.6 system-ui,sans-serif;max-width:40rem;margin:3rem auto;padding:0 1rem"><h1 style="font-size:1.5rem">${title2}</h1><p>${text}</p><p><a href="/${ru ? "ru" : "uz"}/contacts/">${back}</a></p>`,
    { status: 502, headers: { "Content-Type": "text/html; charset=utf-8" } }
  );
}
__name(nativeFailure, "nativeFailure");
__name2(nativeFailure, "nativeFailure");
async function onRequestPost(context2) {
  const { request, env: env2 } = context2;
  const host = new URL(request.url).host;
  const foreign = /* @__PURE__ */ __name2((value) => {
  ...
  const redirectTo = /* @__PURE__ */ __name2((path) => Response.redirect(new URL(path, request.url).toString(), 303), "redirectTo");
  ...
  if (!env2.TG_TOKEN || !env2.TG_CHAT_ID) {
...
${text}`);
  ...
  const failure = await sendTelegram(env2, text);
  if (failure) {
...
// .wrangler/tmp/bundle-8HFVLY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-8HFVLY/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8555749953428791.js.map
